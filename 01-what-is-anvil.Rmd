...
```
Next you will go to STEP 2. For this you will select "I have a billing account".
...
It may take a few minutes for these changes to become active, but then you can go back to AnVIL and check that you have added terra as a billing manager.
