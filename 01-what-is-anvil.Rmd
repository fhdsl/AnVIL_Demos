...
ottrpal::include_slide( "https://docs.google.com/presentation/d/1bY6V6YTMmmBtw-xiiMlVeB-KbvHE3p33R4JHTkaxcwU/edit#slide=id.g24f58a64a6b_0_1" )
```
If you have set up billing before, or if your instructor has provided a billing project you can skip the next section and move on ahead to the [Starting a cloud environment section](#start-a-cloud-environment).
