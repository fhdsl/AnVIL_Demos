...
## specifically comparing the number of rows of each table (left side of the double equals) to the number of rows in the first column of the table that has the word "Demos" in it (right side of the double equals) 
