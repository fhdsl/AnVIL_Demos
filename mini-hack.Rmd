...
1.  Launch Terra
2.  Clone Workspace
3.  Set up RStudio workspace
4.  Recreate figures from the Multi-ancestry Analysis of Gene Expression (MAGE) study 
...
-   Reproduce figures from a peer-reviewed publication using open-access data :::{.notice} To follow along with these exercises, you will need to complete the steps described in the [Preparation](#mini-hack-preparation) guide for this demo. ::: \## Structure of steps
