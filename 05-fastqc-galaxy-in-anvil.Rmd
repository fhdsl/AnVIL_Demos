...
```
  ...
  4C. Click the two sample `.fastq` file checkboxes to select them.
...
```
  ...
  4D. These files will be highlighted in green and click “Ok”.
...
5. Repeat steps 2 and 3 from above.
  ...
  5A. Click on “Choose remote files” at the bottom of the popup.
...
```
  ...
  5B. Double-click the Workspace folder.
...
6. Upload the reference genome file
  ...
  6A. Again, double click "Tables/".

```{r, echo=FALSE, fig.alt="Screenshot of the Galaxy Data upload popup pane, highlighting the Tables/ folder where linked data will be in a cloned workspace"}
ottrpal::include_slide("https://docs.google.com/presentation/d/1zre8qeE9x56RSjusIF3XcuHoxqGf30nfdvjwCoEMd8o/edit#slide=id.g325209e7a14_0_1122")
```

  6B. This time, double click "reference/".
...
```
  ...
  6D. This file will be highlighted green and click "Ok".
...
```{r, echo=FALSE, fig.alt = "Screenshot of Galaxy in AnVIL with an arrow pointing to the tool search bar in the upper left corner. THe tools icon is also highlighted on the far left in case you have to first navigate there to see the search bar."}
...
```{r, echo=FALSE, fig.alt = "Screenshot of Galaxy in AnVIL showing the FastQC tool menu has been opened in the middle pane."}
...
4A. Select the Versions icon (3 cubes).

```{r, echo=FALSE, fig.alt="Screenshot of Galaxy in AnVIL highlighting the versions icon in the gray banner at the top of the middle pane"}
...
4B. Select "Switch to 0.73+galaxy0" from the dropdown menu.

```{r, echo=FALSE, fig.alt="Screenshot of Galaxy in AnVIL highlighting which version of FastQC to switch to in the dropdown menu for tool versions."}
...
4C. Confirm that the version now says "Selected 0.73+galaxy0".

```{r, echo=FALSE, fig.alt="Screenshot of Galaxy in AnVIL highlighting what the version dropdown menu should display."}
...
```{r, echo=FALSE, fig.alt="Screenshot of Galaxy in AnVIL highlighting the input for the tool, specifically selecting the forward reads fastq file for the 'Raw read data from your current history'"}
...
```{r, echo=FALSE, fig.alt = "Screenshot of Galaxy in AnVIL highlighting the blue 'Run Tool' button in the top right corner of the middle pane."}
...
```{r, echo=FALSE, fig.alt = "Screenshot of Galaxy in AnVIL showing how the middle pane and history pane look after submitting a job before it successfully runs."}
...
```{r, echo=FALSE, fig.alt = "Screenshot of Galaxy in AnVIL showing the outputs highlighted in green within the history pane."}
...
<details><summary>FastQC summary report explained</summary>
...
```{r, echo=FALSE, fig.alt = "Screenshot of Galaxy in AnVIL highlighting the floppy disk/save icon for the results that you want to export."}
