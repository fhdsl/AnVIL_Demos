...
- https://jhudatascience.org/AnVIL_Book_Getting_Started/data-analysts.html
...
You can navigate to MAGE Workspace directly through this link: [https://anvil.terra.bio/#workspaces/anvil-outreach/demos-explore-mage](https://anvil.terra.bio/#workspaces/anvil-outreach/demos-explore-mage)
...
1. 'Browse workspace files' button - which contains any files stored in this Workspace (see Review Key Concepts for important note about Cloned Workspaces) as well as notebooks listed in the ANALYSIS tab.
