...
The **Data** tab contains all the files associated with the Workspace - data, scripts, outputs, etc.  Terra provides **Data Tables** to help organize data and results.
...
To get started, navigate to your cloned copy of `shorts-combine-data-workspaces`.  You can find your Workspace in Terra by clicking on "Workspaces" in the dropdown menue, or you can go there directly at [`anvil.terra.bio/#workspaces`](https://anvil.terra.bio/#workspaces).
