...
- Clone your own copy of the [`demos-combine-data-workspaces`](https://anvil.terra.bio/#workspaces/anvil-outreach/demos-combine-data-workspaces) Workspace.
- Launch a Jupyter Cloud Environment with the default settings (in your cloned Workspace).
