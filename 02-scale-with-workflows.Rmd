...
Under the "WORKFLOWS" tab you will see any Workflows that have been imported into your Workspace.  If you import a Workflow from Dockstore (using the Launch with AnVIL button) or from another Workspace, you will see it here.  In this Workspace, the `qc-analysis-pipeline` has already been imported for you.
...
**3.** Choose samples - click the "SELECT DATA" button and check the samples you want to run the Workflow on.
