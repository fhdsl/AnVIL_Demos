...
**Q2.** What demographic information is available in the Data Table named `participants`?

**Q2.** What types of files are linked to in the Data Table named `assembly_sample`?
